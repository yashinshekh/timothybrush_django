...
# timothybrush_django/
APPS_DIR = BASE_DIR / "timothybrush_django"
env = environ.Env()
...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres:///timothybrush_django",
    ),
}
...
LOCAL_APPS = [
    ...
    "timothybrush_django.users.templatetags",
...
MIGRATION_MODULES = {"sites": "timothybrush_django.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "timothybrush_django.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
PAYPAL_RECEIVER_EMAIL = 'sb-zfskd29494008@business.example.com'
PAYPAL_TEST = True
